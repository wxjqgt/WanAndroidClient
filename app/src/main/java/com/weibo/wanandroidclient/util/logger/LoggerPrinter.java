package com.weibo.wanandroidclient.util.logger;
...
import static com.weibo.wanandroidclient.util.logger.Logger.ASSERT;
import static com.weibo.wanandroidclient.util.logger.Logger.DEBUG;
import static com.weibo.wanandroidclient.util.logger.Logger.ERROR;
import static com.weibo.wanandroidclient.util.logger.Logger.INFO;
import static com.weibo.wanandroidclient.util.logger.Logger.VERBOSE;
import static com.weibo.wanandroidclient.util.logger.Logger.WARN;
import static com.weibo.wanandroidclient.util.logger.Utils.checkNotNull;
