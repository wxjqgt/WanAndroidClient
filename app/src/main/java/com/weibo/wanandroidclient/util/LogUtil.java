...
import com.weibo.wanandroidclient.app.WanAndroidClientApp;
...
public final class LogUtil {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = WanAndroidClientApp.CONTEXT
                    .getPackageManager()
                    .getPackageInfo(WanAndroidClientApp.CONTEXT.getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private String mGlobalTag = "Wan";  // The global tag of log.
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && WanAndroidClientApp.CONTEXT.getExternalCacheDir() != null) {
                mDefaultDir = WanAndroidClientApp.CONTEXT.getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                mDefaultDir = WanAndroidClientApp.CONTEXT.getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
